  ...
  return (
    <Section className="flex-center-C">
      ...
      <div className="btn-container flex-center-C">
        ...
        <p>또는</p>
        <button className="kakao-btn" onClick={oauthHelpers.googleLogin}>
          구글로 계속하기
        </button>
        <button className="google-btn" onClick={oauthHelpers.kakaoLogin}>
          카카오로 계속하기
        </button>
        <button className="naver-btn" onClick={oauthHelpers.googleLogout}>
          네이버로 계속하기
        </button>
      </div>
    </Section>
